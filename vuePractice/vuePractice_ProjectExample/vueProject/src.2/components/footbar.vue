<template>
    ...
    <div class="foot-btn" >
      <ul>
        <router-link class="home" active-class="home1" tag="li" to="/home"><a href="javascript:;" ></a></router-link>
        <router-link class="write" active-class="write1" tag="li" to="/follow"><a href="javascript:;" ></a></router-link>
        <router-link class="my" active-class="my1" tag="li" to="/user"><a href="javascript:;" ></a></router-link>
      </ul>
    </div>
</template>
<style>
